...
export interface RootQueryToAnimalConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: Maybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: Maybe<Scalars["Boolean"]>;
  ...
  /** Show posts with a specific status. */
  status?: Maybe<PostStatusEnum>;
  taxQuery?: Maybe<RootQueryToAnimalConnectionWhereArgsTaxQuery>;
  /** Title of the object */
  title?: Maybe<Scalars["String"]>;
}

/** Query objects based on taxonomy parameters */
export interface RootQueryToAnimalConnectionWhereArgsTaxQuery {
  relation?: Maybe<RelationEnum>;
  taxArray?: Maybe<Array<Maybe<RootQueryToAnimalConnectionWhereArgsTaxArray>>>;
}

export interface RootQueryToAnimalConnectionWhereArgsTaxArray {
  field?: Maybe<RootQueryToAnimalConnectionWhereArgsTaxQueryField>;
  /** Whether or not to include children for hierarchical taxonomies. Defaults to false to improve performance (note that this is opposite of the default for WP_Query). */
  includeChildren?: Maybe<Scalars["Boolean"]>;
  operator?: Maybe<RootQueryToAnimalConnectionWhereArgsTaxQueryOperator>;
  taxonomy?: Maybe<TaxonomyEnum>;
  /** A list of term slugs */
  terms?: Maybe<Array<Maybe<Scalars["String"]>>>;
}
...
/** Which field to select taxonomy term by. Default value is "term_id" */
export enum RootQueryToAnimalConnectionWhereArgsTaxQueryField {
  ID = "ID",
  NAME = "NAME",
  SLUG = "SLUG",
  TAXONOMY_ID = "TAXONOMY_ID",
...
export enum RootQueryToAnimalConnectionWhereArgsTaxQueryOperator {
  AND = "AND",
  EXISTS = "EXISTS",
  IN = "IN",
  NOT_EXISTS = "NOT_EXISTS",
...
/** Arguments for filtering the TypeToTypeConnection connection */
export interface TypeToTypeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: Maybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: Maybe<Scalars["Int"]>;
...
export interface RootQueryToTeamMemberConnectionWhereArgs {
  ...
  /** Show posts with a specific status. */
  status?: Maybe<PostStatusEnum>;
  taxQuery?: Maybe<RootQueryToTeamMemberConnectionWhereArgsTaxQuery>;
  /** Title of the object */
  title?: Maybe<Scalars["String"]>;
}
...
export interface RootQueryToTeamMemberConnectionWhereArgsTaxQuery {
  relation?: Maybe<RelationEnum>;
  taxArray?: Maybe<
    Array<Maybe<RootQueryToTeamMemberConnectionWhereArgsTaxArray>>
  >;
}

export interface RootQueryToTeamMemberConnectionWhereArgsTaxArray {
  field?: Maybe<RootQueryToTeamMemberConnectionWhereArgsTaxQueryField>;
  /** Whether or not to include children for hierarchical taxonomies. Defaults to false to improve performance (note that this is opposite of the default for WP_Query). */
  includeChildren?: Maybe<Scalars["Boolean"]>;
  operator?: Maybe<RootQueryToTeamMemberConnectionWhereArgsTaxQueryOperator>;
  taxonomy?: Maybe<TaxonomyEnum>;
  /** A list of term slugs */
  terms?: Maybe<Array<Maybe<Scalars["String"]>>>;
}
...
/** Arguments for filtering the RootQueryToTypeConnection connection */
export interface RootQueryToTypeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: Maybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: Maybe<Scalars["Int"]>;
...
/** Input for the createType mutation */
export interface CreateTypeInput {
  /** The slug that the type will be an alias of */
  aliasOf?: Maybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** The description of the type object */
  description?: Maybe<Scalars["String"]>;
  /** The name of the type object to mutate */
  name: Scalars["String"];
  /** The ID of the type that should be set as the parent */
  parentId?: Maybe<Scalars["ID"]>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: Maybe<Scalars["String"]>;
}
...
/** Input for the deleteType mutation */
...
/** Input for the UpdateType mutation */
export interface UpdateTypeInput {
  ...
  /** The description of the type object */
  description?: Maybe<Scalars["String"]>;
  /** The ID of the type object to update */
  id: Scalars["ID"];
  /** The name of the type object to mutate */
  name?: Maybe<Scalars["String"]>;
  /** The ID of the type that should be set as the parent */
...
export const scalarsEnumsHash: import("gqless").ScalarsEnumsHash = {
  ...
  RootQueryToAnimalConnectionWhereArgsTaxQueryField: true,
  RootQueryToAnimalConnectionWhereArgsTaxQueryOperator: true,
  CategoryIdType: true,
...
export const generatedSchema = {
  query: {
    ...
    animal: {
      __type: "Animal",
      __args: { id: "ID!", idType: "AnimalIdType", asPreview: "Boolean" },
    },
    animalBy: {
      __type: "Animal",
      __args: { id: "ID", animalId: "Int", uri: "String", slug: "String" },
    },
    animals: {
      __type: "RootQueryToAnimalConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
    ...
    type: { __type: "Type", __args: { id: "ID!", idType: "TypeIdType" } },
    types: {
      __type: "RootQueryToTypeConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "RootQueryToTypeConnectionWhereArgs",
      },
    },
    user: {
      __type: "User",
  ...
  mutation: {
    __typename: { __type: "String!" },
    createAnimal: {
      __type: "CreateAnimalPayload",
      __args: { input: "CreateAnimalInput!" },
    },
    createCategory: {
    ...
    createType: {
      __type: "CreateTypePayload",
      __args: { input: "CreateTypeInput!" },
    },
    createUser: {
    ...
    deleteAnimal: {
      __type: "DeleteAnimalPayload",
      __args: { input: "DeleteAnimalInput!" },
    },
    deleteCategory: {
    ...
    deleteType: {
      __type: "DeleteTypePayload",
      __args: { input: "DeleteTypeInput!" },
    },
    deleteUser: {
    ...
    updateAnimal: {
      __type: "UpdateAnimalPayload",
      __args: { input: "UpdateAnimalInput!" },
    },
    updateCategory: {
    ...
    updateType: {
      __type: "UpdateTypePayload",
      __args: { input: "UpdateTypeInput!" },
    },
    updateUser: {
  ...
  Animal: {
    ...
    preview: { __type: "AnimalToPreviewConnectionEdge" },
  ...
  AnimalToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Animal" },
  },
  RootQueryToAnimalConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
    ...
    stati: { __type: "[PostStatusEnum]" },
    status: { __type: "PostStatusEnum" },
    taxQuery: { __type: "RootQueryToAnimalConnectionWhereArgsTaxQuery" },
    title: { __type: "String" },
  },
  RootQueryToAnimalConnectionWhereArgsTaxQuery: {
    relation: { __type: "RelationEnum" },
    taxArray: { __type: "[RootQueryToAnimalConnectionWhereArgsTaxArray]" },
  },
  RootQueryToAnimalConnectionWhereArgsTaxArray: {
    field: { __type: "RootQueryToAnimalConnectionWhereArgsTaxQueryField" },
    includeChildren: { __type: "Boolean" },
    operator: {
      __type: "RootQueryToAnimalConnectionWhereArgsTaxQueryOperator",
    },
    taxonomy: { __type: "TaxonomyEnum" },
    terms: { __type: "[String]" },
  },
  RootQueryToAnimalConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToAnimalConnectionEdge]" },
    nodes: { __type: "[Animal]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  Type: {
    __typename: { __type: "String!" },
    ancestors: {
      __type: "TypeToAncestorsTypeConnection",
      __args: { first: "Int", last: "Int", after: "String", before: "String" },
    },
    children: {
      __type: "TypeToTypeConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "TypeToTypeConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    count: { __type: "Int" },
    ...
    link: { __type: "String" },
    name: { __type: "String" },
    parent: { __type: "TypeToParentTypeConnectionEdge" },
    parentDatabaseId: { __type: "Int" },
    parentId: { __type: "ID" },
    slug: { __type: "String" },
    taxonomy: { __type: "TypeToTaxonomyConnectionEdge" },
    templates: { __type: "[String]" },
    termGroupId: { __type: "Int" },
    termTaxonomyId: { __type: "Int" },
    typeId: { __type: "Int" },
  ...
  TypeToAncestorsTypeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[TypeToAncestorsTypeConnectionEdge]" },
    nodes: { __type: "[Type]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  TypeToAncestorsTypeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Type" },
  },
  TypeToTypeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  TypeToTypeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[TypeToTypeConnectionEdge]" },
    nodes: { __type: "[Type]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  TypeToTypeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Type" },
  },
  ...
  RootQueryToTeamMemberConnectionWhereArgsTaxArray: {
    ...
    includeChildren: { __type: "Boolean" },
    operator: {
      __type: "RootQueryToTeamMemberConnectionWhereArgsTaxQueryOperator",
    },
    taxonomy: { __type: "TaxonomyEnum" },
    terms: { __type: "[String]" },
  },
  ...
  RootQueryToTypeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToTypeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToTypeConnectionEdge]" },
    nodes: { __type: "[Type]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToTypeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Type" },
  },
...
export interface Query {
  ...
  animals: (args?: {
    ...
    where?: Maybe<RootQueryToAnimalConnectionWhereArgs>;
  }) => Maybe<RootQueryToAnimalConnection>;
  categories: (args?: {
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    after?: Maybe<Scalars["String"]>;
  ...
  types: (args?: {
    ...
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    where?: Maybe<RootQueryToTypeConnectionWhereArgs>;
  }) => Maybe<RootQueryToTypeConnection>;
  user: (args: {
    id: Scalars["ID"];
...
export interface Mutation {
  ...
  createType: (args: { input: CreateTypeInput }) => Maybe<CreateTypePayload>;
  createUser: (args: { input: CreateUserInput }) => Maybe<CreateUserPayload>;
  deleteAnimal: (args: {
    input: DeleteAnimalInput;
  }) => Maybe<DeleteAnimalPayload>;
  deleteCategory: (args: {
  ...
  deleteType: (args: { input: DeleteTypeInput }) => Maybe<DeleteTypePayload>;
  ...
  updateType: (args: { input: UpdateTypeInput }) => Maybe<UpdateTypePayload>;
...
export interface Animal
  ...
  __typename: "Animal" | undefined;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  animalId: ScalarsEnums["Int"];
  animalpic?: Maybe<MediaItem>;
 ...
 * Connection between the animal type and the animal type
 */
export interface AnimalToPreviewConnectionEdge {
  __typename: "AnimalToPreviewConnectionEdge" | undefined;
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Animal>;
 ...
 */
export interface RootQueryToAnimalConnection {
  __typename: "RootQueryToAnimalConnection" | undefined;
  /**
   * Edges for the RootQueryToAnimalConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToAnimalConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Animal>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToAnimalConnectionEdge {
  __typename: "RootQueryToAnimalConnectionEdge" | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Type
  ...
  ancestors: (args?: {
     ...
     */;
    before?: Maybe<Scalars["String"]>;
  }) => Maybe<TypeToAncestorsTypeConnection>;
  /**
   * Connection between the type type and the type type
   */
  children: (args?: {
    /**
     * The number of items to return after the referenced "after" cursor
     ...
     * Arguments for filtering the connection
     */;
    where?: Maybe<TypeToTypeConnectionWhereArgs>;
  }) => Maybe<TypeToTypeConnection>;
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * The number of objects connected to the object
   */
   ...
   * Connection between the type type and the type type
   */
  parent?: Maybe<TypeToParentTypeConnectionEdge>;
  /**
   * Database id of the parent node
   */
  parentDatabaseId?: Maybe<ScalarsEnums["Int"]>;
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the type type and the Taxonomy type
   */
  taxonomy?: Maybe<TypeToTaxonomyConnectionEdge>;
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The ID of the term group that this term object belongs to
   */
 ...
 * Connection between the type type and the type type
 */
export interface TypeToAncestorsTypeConnection {
  __typename: "TypeToAncestorsTypeConnection" | undefined;
  /**
   * Edges for the TypeToAncestorsTypeConnection connection
   */
  edges?: Maybe<Array<Maybe<TypeToAncestorsTypeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface TypeToAncestorsTypeConnectionEdge {
  __typename: "TypeToAncestorsTypeConnectionEdge" | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the type type and the type type
 */
export interface TypeToTypeConnection {
  __typename: "TypeToTypeConnection" | undefined;
  /**
   * Edges for the TypeToTypeConnection connection
   */
  edges?: Maybe<Array<Maybe<TypeToTypeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Type>>>;
 ...
 * An edge in a connection
 */
export interface TypeToTypeConnectionEdge {
  __typename: "TypeToTypeConnectionEdge" | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the type type and the type type
 */
export interface TypeToParentTypeConnectionEdge {
  __typename: "TypeToParentTypeConnectionEdge" | undefined;
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Type>;
 ...
 * Connection between the type type and the Taxonomy type
 */
export interface TypeToTaxonomyConnectionEdge {
  __typename: "TypeToTaxonomyConnectionEdge" | undefined;
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Taxonomy>;
...
/**
 * Connection between the RootQuery type and the type type
 */
export interface RootQueryToTypeConnection {
  __typename: "RootQueryToTypeConnection" | undefined;
  /**
   * Edges for the RootQueryToTypeConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToTypeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Type>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToTypeConnectionEdge {
  __typename: "RootQueryToTypeConnectionEdge" | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface CreateAnimalPayload {
  __typename: "CreateAnimalPayload" | undefined;
  /**
...
/**
 * The payload for the createType mutation
 */
export interface CreateTypePayload {
  __typename: "CreateTypePayload" | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface DeleteAnimalPayload {
  __typename: "DeleteAnimalPayload" | undefined;
  /**
...
/**
 * The payload for the deleteType mutation
 */
export interface DeleteTypePayload {
  __typename: "DeleteTypePayload" | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface UpdateAnimalPayload {
  __typename: "UpdateAnimalPayload" | undefined;
  /**
   * The Post object mutation type.
   */
  animal?: Maybe<Animal>;
...
/**
 * The payload for the UpdateType mutation
 */
export interface UpdateTypePayload {
  __typename: "UpdateTypePayload" | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface SchemaObjectTypes {
  ...
  UserRole: UserRole;
  AnimalToPreviewConnectionEdge: AnimalToPreviewConnectionEdge;
  RootQueryToAnimalConnection: RootQueryToAnimalConnection;
  RootQueryToAnimalConnectionEdge: RootQueryToAnimalConnectionEdge;
  ...
  Type: Type;
  TypeToAncestorsTypeConnection: TypeToAncestorsTypeConnection;
  TypeToAncestorsTypeConnectionEdge: TypeToAncestorsTypeConnectionEdge;
  TypeToTypeConnection: TypeToTypeConnection;
  TypeToTypeConnectionEdge: TypeToTypeConnectionEdge;
  TypeToParentTypeConnectionEdge: TypeToParentTypeConnectionEdge;
  TypeToTaxonomyConnectionEdge: TypeToTaxonomyConnectionEdge;
  ...
  RootQueryToTypeConnection: RootQueryToTypeConnection;
  RootQueryToTypeConnectionEdge: RootQueryToTypeConnectionEdge;
  ...
  CreateAnimalPayload: CreateAnimalPayload;
  ...
  CreateTypePayload: CreateTypePayload;
  CreateUserPayload: CreateUserPayload;
  DeleteAnimalPayload: DeleteAnimalPayload;
  ...
  DeleteTypePayload: DeleteTypePayload;
  ...
  UpdateAnimalPayload: UpdateAnimalPayload;
  ...
  UpdateTypePayload: UpdateTypePayload;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  AnimalIdType: AnimalIdType | undefined;
  ...
  UserToContentRevisionUnionConnectionWhereArgsTaxQueryOperator:
    | UserToContentRevisionUnionConnectionWhereArgsTaxQueryOperator
    | undefined;
  RootQueryToAnimalConnectionWhereArgsTaxQueryField:
    | RootQueryToAnimalConnectionWhereArgsTaxQueryField
    | undefined;
  RootQueryToAnimalConnectionWhereArgsTaxQueryOperator:
    | RootQueryToAnimalConnectionWhereArgsTaxQueryOperator
    | undefined;
  ...
  TypeIdType: TypeIdType | undefined;
